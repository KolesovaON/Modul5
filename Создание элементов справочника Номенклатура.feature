...
создать множество элементов справочника Номенклатуры 
...
Сценарий: создание элементов справочника Номенклатура
    ...
    И я делаю 10 раз
        ...
        И Я запоминаю значение выражения '"Элемент справочника Номенклатура" + $Шаг$' в переменную "НаименованиеНоменклатуры"
